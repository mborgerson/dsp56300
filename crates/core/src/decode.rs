...
const OPCODE_TABLE: [OpcodeEntry; 185] = [
        ...
        op!("0000101101MMMRRR0S0bbbbb", "bchg #n, [X or Y]:ea", bit ea, BchgEa),
        op!("0000101100aaaaaa0S0bbbbb", "bchg #n, [X or Y]:aa", bit aa, BchgAa),
        op!("0000101110pppppp0S0bbbbb", "bchg #n, [X or Y]:pp", bit pp, BchgPp),
        op!("0000000101qqqqqq0S0bbbbb", "bchg #n, [X or Y]:qq", bit qq, BchgQq),
        op!("0000101111DDDDDD010bbbbb", "bchg #n, D", bit reg, BchgReg),
        op!("0000101001MMMRRR0S0bbbbb", "bclr #n, [X or Y]:ea", bit ea, BclrEa),
        op!("0000101000aaaaaa0S0bbbbb", "bclr #n, [X or Y]:aa", bit aa, BclrAa),
        op!("0000101010pppppp0S0bbbbb", "bclr #n, [X or Y]:pp", bit pp, BclrPp),
        op!("0000000100qqqqqq0S0bbbbb", "bclr #n, [X or Y]:qq", bit qq, BclrQq),
        ...
        no_mode6(op!("0000101001MMMRRR1S0bbbbb", "jclr #n, [X or Y]:ea, xxxx", bit ea, JclrEa)),
        op!("0000101000aaaaaa1S0bbbbb", "jclr #n, [X or Y]:aa, xxxx", bit aa, JclrAa),
        op!("0000101010pppppp1S0bbbbb", "jclr #n, [X or Y]:pp, xxxx", bit pp, JclrPp),
        op!("0000000110qqqqqq1S0bbbbb", "jclr #n, [X or Y]:qq, xxxx", bit qq, JclrQq),
        op!("0000101011DDDDDD000bbbbb", "jclr #n, S, xxxx", bit reg, JclrReg),
        ...
        no_mode6(op!("0000101101MMMRRR1S0bbbbb", "jsclr #n, [X or Y]:ea, xxxx", bit ea, JsclrEa)),
        op!("0000101100aaaaaa1S0bbbbb", "jsclr #n, [X or Y]:aa, xxxx", bit aa, JsclrAa),
        ...
        no_mode6(op!("0000101001MMMRRR1S1bbbbb", "jset #n, [X or Y]:ea, xxxx", bit ea, JsetEa)),
        op!("0000101000aaaaaa1S1bbbbb", "jset #n, [X or Y]:aa, xxxx", bit aa, JsetAa),
        op!("0000101010pppppp1S1bbbbb", "jset #n, [X or Y]:pp, xxxx", bit pp, JsetPp),
        op!("0000000110qqqqqq1S1bbbbb", "jset #n, [X or Y]:qq, xxxx", bit qq, JsetQq),
        op!("0000101011DDDDDD001bbbbb", "jset #n, S, xxxx", bit reg, JsetReg),
        op!("0000101111MMMRRR10000000", "jsr ea", ea, JsrEa),
        op!("000011010000aaaaaaaaaaaa", "jsr xxx", |T, opc| Jsr { addr: tmpl_field(T, b'a', opc) }),
        no_mode6(op!("0000101101MMMRRR1S1bbbbb", "jsset #n, [X or Y]:ea, xxxx", bit ea, JssetEa)),
        op!("0000101100aaaaaa1S1bbbbb", "jsset #n, [X or Y]:aa, xxxx", bit aa, JssetAa),
